...
public class BackgroundActivity extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void initActions() {
        ...
        IvBackgroundImg.setBackgroundColor(new MySharePref(context).getPrefInt(MySharePref.DEFAULT_BG_COLOR, ViewCompat.MEASURED_STATE_MASK));
        new MySharePref(context).putPrefBoolean(MySharePref.ISCOLOR_CODE_CHANGE, true);
        int color = new MySharePref(context).getPrefInt(MySharePref.TEXT_IS_COLOR_CODE, -1);
        GotoFontColor(color);
        GotoFontTypeface();
